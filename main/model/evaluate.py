...
def preprocess_result(filepath):
	...
	f1 = open(test_path,"w",encoding='utf-8')
	f2 = open(infer_path,"w",encoding='utf-8')
	for line in f:
...
if __name__ == '__main__':
	...
	with open(opt.result_path,encoding='utf-8') as f:
		ref, tgt = [], []
	...
	num = 0
	idx = 0
	out_file = open(ip,'r',encoding='utf-8')
	candidate = []
	bleu_score_all_1 = 0
	bleu_score_all_2 = 0
	bleu_score_all_3 = 0
	...
	for line in out_file:
		if False:
			...
			r = line.strip().split(' ')
		candidate.append(r)
	with open(corpus_train,'r',encoding='utf-8') as f:
