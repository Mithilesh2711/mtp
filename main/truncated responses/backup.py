...
dir_list2 = os.listdir("D:\mtp\DHAP chinese\DHAP\FData40")
print(len(dir_list))
c=0
...
for file in dir_list:
    ...
    if(os.path.getsize("D:/mtp/DHAP chinese/DHAP/TData2/"+file)>100000):
        ...
        with open("D:/mtp/DHAP chinese/DHAP/TData2/"+file, encoding='utf-8') as f, open("D:/mtp/DHAP chinese/DHAP/FData40/"+file,'a',encoding='utf-8') as file1:
            for line in f:
                if(c in idx):
                    file1.write(line)
                c+=1
